// ─────────────────────────────────────────────────────────────
// EDIT ME: this is the main file to personalize the site.
// Every bracketed value like [YOUR NAME] should be replaced.
// ─────────────────────────────────────────────────────────────

export const profile = {
  name: 'Ankit Kumar Yadav',
  roles: ['Computer Engineering Student', 'Developer', 'Builder'],
  tagline:
    'I build digital experiences, experiment with technology, and turn ideas into reality.',
...
// Terminal-style hero readout. Edit freely — this is the lines that
// "type" themselves out on the homepage.
